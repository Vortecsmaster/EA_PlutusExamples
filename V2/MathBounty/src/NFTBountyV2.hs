...
scrAddress = Scripts.validatorAddress bountyValidator                 -- New functino to derive the address, included in the Utils library
--scrAddress = scriptAddress bountyValidator 
