...
{-# INLINABLE homework #-}
homework :: BuiltinData -> BuiltinData -> BuiltinData -> ()
homework datum _ _ 
 | datum == Builtins.mkI 19 = ()
 | otherwise                = traceError "Wrong datum"

{-# INLINABLE homework1 #-}
homework1 :: BuiltinData -> BuiltinData -> BuiltinData -> ()
homework1  _  redeemer _ 
 | redeemer == Builtins.mkI 19 = ()
 | otherwise                   = traceError "Wrong redeemer"

{-# INLINABLE homework2 #-}
homework2 :: BuiltinData -> BuiltinData -> BuiltinData -> ()
homework2 datum redeemer _ 
 | datum    == Builtins.mkI 19 = ()
 | redeemer == Builtins.mkI 19 = ()
 | otherwise                   = traceError "Not the right datum or redeemer"



validator :: Validator
validator = mkValidatorScript $$(PlutusTx.compile [|| homework ||])  
...
validator1 = mkValidatorScript $$(PlutusTx.compile [|| homework1 ||])  
...
validator2 = mkValidatorScript $$(PlutusTx.compile [|| homework2 ||])  
...
writeH1 :: IO ()
writeH1 = void $ writeFileTextEnvelope "./testnet/d19.plutus" Nothing serialisedScript

serialisedScript1 :: PlutusScript PlutusScriptV2
serialisedScript1 = PlutusScriptSerialised scriptSBS1

writeH2 :: IO ()
writeH2 = void $ writeFileTextEnvelope "./testnet/r19.plutus" Nothing serialisedScript1

serialisedScript2 :: PlutusScript PlutusScriptV2
serialisedScript2 = PlutusScriptSerialised scriptSBS2

writeH3 :: IO ()
writeH3 = void $ writeFileTextEnvelope "./testnet/dr19.plutus" Nothing serialisedScript2
...
writeValue :: IO ()
writeValue = writeJSON "./testnet/value19.json" ( 19 :: Integer)
