...
vestingValidator :: VestingDatum -> Integer -> ScriptContext -> Bool
vestingValidator dat redeemer ctx = traceIfFalse "Beneficiary's signature missing" signedByBeneficiary &&
                              traceIfFalse "Deadline not reache" deadlineReached
    where
        info :: TxInfo
...
instance Scripts.ValidatorTypes Vesting where
    ...
    type instance RedeemerType Vesting = Integer                      -- Instance for the Reedemer
